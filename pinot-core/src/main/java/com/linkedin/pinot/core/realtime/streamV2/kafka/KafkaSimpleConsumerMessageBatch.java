...
public class KafkaSimpleConsumerMessageBatch implements MessageBatch<byte[]> {

  private ArrayList<MessageAndOffset> messageList = new ArrayList<>();

  public KafkaSimpleConsumerMessageBatch(Iterable<MessageAndOffset> messageAndOffsetIterable) {
